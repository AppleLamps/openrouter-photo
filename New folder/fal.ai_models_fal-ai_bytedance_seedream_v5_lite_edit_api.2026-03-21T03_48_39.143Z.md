...
[Log-in](https://fal.ai/login?returnTo=/models/fal-ai/bytedance/seedream/v5/lite/edit/api) [Sign-up](https://fal.ai/login?returnTo=/models/fal-ai/bytedance/seedream/v5/lite/edit/api)
...
[Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/bytedance/seedream/v5/lite/edit)

[LLMs](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/llms.txt)

[Playground](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/playground) [API](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api) [Examples](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/examples)

### Table of contents

JavaScript / Node.js

[**1\. Calling the API**](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#api-call)

- [Install the client](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#api-call-install)
- [Setup your API Key](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#api-call-setup)
- [Submit a request](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#api-call-submit-request)

[**2\. Authentication**](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#auth)

- [API Key](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#auth-api-key)

[**3\. Queue**](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#queue)

- [Submit a request](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#queue-submit)
- [Fetch request status](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#queue-status)
- [Get the result](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#queue-result)

[**4\. Files**](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#files)

- [Data URI (base64)](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#files-data-uri)
- [Hosted files (URL)](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#files-from-url)
- [Uploading files](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#files-upload)

[**5\. Schema**](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#schema)

- [Input](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#schema-input)
- [Output](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#schema-output)
- [Other](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#schema-other)

### About

Edit images using Bytedance's SeedDream 5.0 Lite model.

### 1\. Calling the API [\#](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api\#api-call-install)
...
Once the request is completed, you can fetch the result. See the [Output Schema](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api#schema-output) for the expected result format.
...
### Other types [\#](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api\#schema-other)

#### Image [\#](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api\#type-Image)
...
#### File [\#](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api\#type-File)
...
#### ImageSize [\#](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api\#type-ImageSize)
...
#### Seed2MiniMessage [\#](https://fal.ai/models/fal-ai/bytedance/seedream/v5/lite/edit/api\#type-Seed2MiniMessage)
